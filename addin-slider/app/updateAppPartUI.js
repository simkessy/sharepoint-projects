...
(function () {
    ...
    window.startConstosoAppPartPropertyUIOverride = function () {
        (function ($, overrider) {
            ...
            overrider.moveCategoryToTop("SPSlider Settings");
            overrider.expandCategory("SPSlider Settings");
            // overrider.hideProperty("HostWebListTitleHiddenTextBox", "SPSlider Settings");

            // create new custom dropdown list in property UI at runtime
            var listsDropDownJQueryWrapper = $(
                    overrider.createNewContentAtTop({
                        category:"SPSlider Settings",
            ...
            clientContext.executeQueryAsync(
                function () {
                    ...
                    listsDropDownJQueryWrapper.val(overrider.getValue("HostWebListTitleHiddenTextBox", "SPSlider Settings"));
                    ...
                    listsDropDownJQueryWrapper.change(function () {
                        ...
                        overrider.setValue("HostWebListTitleHiddenTextBox", listsDropDownJQueryWrapper.val(), "SPSlider Settings");
                    });

                    // render the tool tips as instructions
                    overrider.renderToolTipsAsInstructions("SPSlider Settings");
